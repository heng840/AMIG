...
if __name__ == "__main__":
    ...
    parser.add_argument('--neurons_result_dir', type=str, default='temp_test')
    ...
    for i, idx in enumerate(tqdm(INDICES, position=args.local_rank)):
        ...
        try:
            ...
            # inac40b023-5194-406b-8548-f16ed5af8941
        ...
        neurons_json_path = RESULTS_DIR / f"2temp_neurons_{args.local_rank}.json"
        results_json_path = RESULTS_DIR / f"2temp_results_{args.local_rank}.json"
