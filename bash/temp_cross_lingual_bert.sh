...
--all_language_results_dir $bert_all_language_output \
--results_jsons $bert_cross_lingual_output/res_0.json $bert_cross_lingual_output/zh2en_0.json $bert_cross_lingual_output/en2zh_0.json
